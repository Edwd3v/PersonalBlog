...
class DataProcessorApp:
    def __init__(self, root):
        ...
        self.label = tk.Label(root, text="Seleccione un archivo Excel:", bg='black', fg='green')  # Texto verde
        self.label.pack(pady=10)

        # Botón para seleccionar el archivo
        self.button = tk.Button(root, text="Seleccionar Archivo", command=self.process_data, bg='black', fg='green')  # Texto verde
        ...
        # Texto informativo
        self.info_text = tk.Text(root, height=10, width=50, bg='black', fg='green')  # Texto verde
        self.info_text.pack(pady=10)

        # Botón de finalizar (inicialmente deshabilitado)
        self.finish_button = tk.Button(root, text="Finalizar", command=self.finish, state=tk.DISABLED, bg='black', fg='green')  # Texto verde
